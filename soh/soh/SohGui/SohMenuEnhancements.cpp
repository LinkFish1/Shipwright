...
void SohMenu::AddMenuEnhancements() {
    ...
    AddWidget(path, "Autosave", WIDGET_CVAR_CHECKBOX)
        ...
        .Options(CheckboxOptions().Tooltip(StringHelper::Translate(
            ...
            "etc.).\n\n"
            "The soft-reset save will *not* trigger in cutscene maps like the Chamber of Sages!").c_str()));
    ...
    AddWidget(path, "Play Zelda's Lullaby to Open Sleeping Waterfall", WIDGET_CVAR_COMBOBOX)
        ...
        .Options(
            ComboboxOptions()
                ...
                .Tooltip(StringHelper::Translate("Always: Link must always play Zelda's Lullaby to open the waterfall entrance to Zora's Domain.\n"
    ...
    AddWidget(path, "Cull Glitch Useful Actors", WIDGET_CVAR_CHECKBOX)
        ...
        .Options(CheckboxOptions().Tooltip(
            StringHelper::Translate("Exclude Actors that are useful for Glitches from the extended culling ranges. Some actors may still draw "
    ...
    AddWidget(path, "Persistent Masks", WIDGET_CVAR_CHECKBOX)
        ...
        .Options(
            CheckboxOptions().Tooltip(StringHelper::Translate("Stops masks from automatically unequipping on certain situations:\n"
